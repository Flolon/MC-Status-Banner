...
function loadMCBanner(){ //send request and kickstart the rest of the banner
    ...
    getMC.open("GET", "https://api.mcsrvstat.us/2/mc.stibarc.gq", true);
    getMC.send();
}
